...
public class AdapterMasakan extends RecyclerView.Adapter<AdapterMasakan.MyViewHolder> {
    ...
    public AdapterMasakan(Context mContext, List<Constactor> constactorList){
    ...
    public void onBindViewHolder (final MyViewHolder holder, final int position){
        ...
        holder.cardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(mContext, DetailResepMasakan.class);
