...
public class AdapterKue extends RecyclerView.Adapter<AdapterKue.MyViewHolder> {
    ...
    public AdapterKue(Context mContext, List<Constactor> constactorList){
    ...
    public void onBindViewHolder (final MyViewHolder holder, final int position){
        ...
        holder.cardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(mContext, DetailResepKue.class);
